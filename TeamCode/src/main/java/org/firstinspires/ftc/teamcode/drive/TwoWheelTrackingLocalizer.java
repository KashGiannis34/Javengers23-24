...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.008988405; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.0178018059; // Multiplier in the Y direction
