...
@Config
@Autonomous (name = "AutoBlueBackdrop_GREEN_LEMONS_COMPLEX_BACKSTAGE")
public class AutoBlueBackdrop_GREEN_LEMONS_COMPLEX_BACKSTAGE extends LinearOpMode {
    RRAutoDrive drive;
    ...
    Vector2d parkVector = new Vector2d(40, 57.75);
...
//            telemetry.addData("Select Alliance (Gamepad1 X = Blue, Gamepad1 B = Red)", "");
        ...
        if (curAlliance == "blue") {
            ...
            trajSeqCenter = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToLinearHeading(new Pose2d(55.5, 32.25, Math.toRadians(180)), velConPixel, accConPixel)
