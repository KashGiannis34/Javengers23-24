...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 9.9;//7.45;//8.5; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.0145;//1.0 / rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = 3;//Math.toRadians(360);
    public static double MAX_ANG_ACCEL = 3; //in radians
    /*
